...
from data.art_dataset import art_train, art_caption_eval, art_retrieval_eval
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    elif dataset == 'caption_art':
        train_dataset = art_train(transform_train, config['image_root'], config['ann_root'], prompt=config['prompt'])
        val_dataset = art_caption_eval(transform_test, config['image_root'], config['ann_root'], 'val')
        test_dataset = art_caption_eval(transform_test, config['image_root'], config['ann_root'], 'test')   
        return train_dataset, val_dataset, test_dataset
